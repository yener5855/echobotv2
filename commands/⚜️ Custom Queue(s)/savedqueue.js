  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      case `addcurrenttrack`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes:1269542579117101116> Added ${track.title} onto the Queue \`${Name}\``.substring(0, 256))
      ...
      case `removesong`: {
        ...
        //return susccess message
        return message.reply({embeds :[new MessageEmbed()
          .setTitle(`<a:yes:1269542579117101116> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substring(0, 256))
      ...
      case `mix`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes:1269542579117101116> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substring(0, 256))
      ...
      case `removeduplicates`: {
        ...
        //return susccess message
        return message.reply({embeds : [new MessageEmbed()
          .setTitle(`<a:yes:1269542579117101116> Removed ${counter} Tracks from the Queue \`${Name}\``.substring(0, 256))
