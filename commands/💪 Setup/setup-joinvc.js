                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:yes:1269542579117101116> I will now send Messages after someone joins the VC \`${Voicechannel.name}\` in the TextChannel **${Textchannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:yes:1269542579117101116> Successfully removed **${Voicechannel.name}** out of the Setup!`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:yes:1269542579117101116> I will now Add the Role \`${Role.name}\` when someone joins the VC **${Discord.VoiceChannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
