    ...
    try {
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Twitter Setup', 'https://cdn.discordapp.com/emojis/1269542295104131202.png?size=96', 'https://discord.com/invite/Yfb2fnkduE')
          ...
          await tempmsg.channel.awaitMessages({
            ...
            .then(async collected => {
              try {
                ...
                message.reply({
                  embeds: [new Discord.MessageEmbed()
                    .setTitle(`<a:yes:1269542579117101116> Set the TWITTER USER ID TO: \`${collected.first().content}\``.substring(0, 256))
                ...
                await tempmsg.channel.awaitMessages({
                  ...
                  .then(async collected => {
                    try {
                      ...
                      return message.reply({
                        embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:yes:1269542579117101116> Set the TWITTER USER Name TO: \`${collected.first().content}\``.substring(0, 256))
