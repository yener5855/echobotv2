      ...
      async function first_layer(){
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "<a:yes:1269542579117101116> **The Current Anti-Nuke Settings**", embeds: [new MessageEmbed()
              .setColor(es.color)
              ...
              menuoptions = [
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.enabled") ? "1269533966009106465": "1269542548771180618"
                },
                {
                  value: "Set Logger",
                ...
                },
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog") ? "1269533966009106465": "1269542548771180618"
                },
                {
                      ...
                      menuoptions = [
                        {
                          ...
                          emoji: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? "1269533966009106465": "1269542548771180618"
                        },
                        {
            ...
            return menu?.reply({content: "<a:yes:1269542579117101116> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
