    ...
    try {
      ...
      async function first_layer(){
        ...
        collector.on("collect", async b => {
          ...
          b?.reply(`<a:yes:1269542579117101116> **\`Enabled ${enabled} Auto-Warn-Rules\` and \`Disabled ${disabled} Auto-Warn-Rules\` out of \`${b?.values.length} selected Auto-Warn-Rules\`**`)
        })
