  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      ...
      await interaction?.reply({embeds: [new MessageEmbed()
        ...
        .setAuthor(client.getAuthor(handlemsg(client.la[ls].cmds.info.commandcount.tempmsg), "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/Xrd2D52pRF"))
      ], ephemeral: true})
      let lines = 0
      let letters = 0
